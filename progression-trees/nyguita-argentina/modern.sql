...
VALUES ('CIVIC_NYGUITA_CONGRESS_OF_TUCUMAN', 'TRADITION_NYGUITA_CAUDILLISM_II', 0,      'KIND_TRADITION', 1),
       ('CIVIC_NYGUITA_CONGRESS_OF_TUCUMAN', 'BUILDING_NYGUITA_SALADERO', 0,      'KIND_CONSTRUCTIBLE', 1),
       ('CIVIC_NYGUITA_CONGRESS_OF_TUCUMAN', 'MOD_MO_SETTLEMENT_CAP_INCREASE', 0,      'KIND_MODIFIER', 1);
...
INSERT INTO ProgressionTreeNodeUnlocks 
       (ProgressionTreeNodeType,                    TargetType,                                 Hidden, TargetKind,       UnlockDepth) 
VALUES ('CIVIC_NYGUITA_CIVILIZATION_AND_BARBARISM', 'TRADITION_NYGUITA_CONQUEST_OF_THE_DESERT_II', 0,      'KIND_TRADITION', 1),
       ('CIVIC_NYGUITA_CIVILIZATION_AND_BARBARISM', 'BUILDING_NYGUITA_BANCO_NACION', 0,      'KIND_CONSTRUCTIBLE', 1),
       ('CIVIC_NYGUITA_CIVILIZATION_AND_BARBARISM', 'MOD_TOT_TRADITION_SLOT', 0,              'KIND_MODIFIER', 1);
...
VALUES ('CIVIC_NYGUITA_TANGO_AND_POETRY', 'WONDER_NYGUITA_PALACIO_BAROLO', 0,      'KIND_CONSTRUCTIBLE', 1),
       ('CIVIC_NYGUITA_TANGO_AND_POETRY', 'TRADITION_NYGUITA_NUEVO_TANGO', 0,      'KIND_TRADITION', 1),
       ('CIVIC_NYGUITA_TANGO_AND_POETRY', 'MOD_TOT_TRADITION_SLOT', 0,              'KIND_MODIFIER', 1);
       --('CIVIC_NYGUITA_TANGO_AND_POETRY', 'MOD_NYGUITA_FLORIDA_AND_BOEDO', 0,      'KIND_MODIFIER', 1),
