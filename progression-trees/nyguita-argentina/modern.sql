...
INSERT INTO ProgressionTreeNodeUnlocks 
       (ProgressionTreeNodeType,                    TargetType,                      Hidden, TargetKind,           UnlockDepth) 
VALUES ('CIVIC_NYGUITA_CIVILIZATION_AND_BARBARISM', 'BUILDING_NYGUITA_BANCO_NACION', 0,      'KIND_CONSTRUCTIBLE', 1);

INSERT INTO ProgressionTreeNodeUnlocks 
       (ProgressionTreeNodeType,                    TargetType,                  Hidden, TargetKind,      UnlockDepth) 
VALUES ('CIVIC_NYGUITA_CIVILIZATION_AND_BARBARISM', 'MOD_NYGUITA_PATRIA_GRANDE', 0,      'KIND_MODIFIER', 2);
...
INSERT INTO ProgressionTreeNodeUnlocks 
       (ProgressionTreeNodeType,                    TargetType,                         Hidden, TargetKind,      UnlockDepth) 
VALUES ('CIVIC_NYGUITA_CIVILIZATION_AND_BARBARISM', 'MOD_NYGUITA_LIGA_DE_GOBERNADORES', 0,      'KIND_MODIFIER', 2);
...
INSERT INTO ModifierArguments 
       (ModifierId,                         Name,     Value) 
VALUES ('MOD_NYGUITA_LIGA_DE_GOBERNADORES', 'Amount', '5');

INSERT INTO ModifierArguments 
       (ModifierId,                         Name,        Value) 
VALUES ('MOD_NYGUITA_LIGA_DE_GOBERNADORES', 'CivUnique', 'True');
...
INSERT INTO ModifierArguments 
       (ModifierId,                      Name,     Value) 
VALUES ('MOD_NYGUITA_FLORIDA_AND_BOEDO', 'Invert', 'True');

INSERT INTO ModifierArguments 
       (ModifierId,                      Name,     Value) 
VALUES ('MOD_NYGUITA_FLORIDA_AND_BOEDO', 'Amount', '5');

INSERT INTO ModifierArguments 
       (ModifierId,                      Name,        Value) 
VALUES ('MOD_NYGUITA_FLORIDA_AND_BOEDO', 'YieldType', 'YIELD_CULTURE');

INSERT INTO ProgressionTreeNodeUnlocks 
       (ProgressionTreeNodeType,          TargetType,                      Hidden, TargetKind,           UnlockDepth) 
VALUES ('CIVIC_NYGUITA_TANGO_AND_POETRY', 'WONDER_NYGUITA_PALACIO_BAROLO', 0,      'KIND_CONSTRUCTIBLE', 1);

INSERT INTO ProgressionTreeNodeUnlocks 
       (ProgressionTreeNodeType,          TargetType,                      Hidden, TargetKind,       UnlockDepth) 
VALUES ('CIVIC_NYGUITA_TANGO_AND_POETRY', 'TRADITION_NYGUITA_NUEVO_TANGO', 0,      'KIND_TRADITION', 2);

INSERT INTO ProgressionTreeNodeUnlocks 
       (ProgressionTreeNodeType,          TargetType,                                Hidden, TargetKind,      UnlockDepth) 
VALUES ('CIVIC_NYGUITA_TANGO_AND_POETRY', 'MOD_NYGUITA_GIANTS_OF_PATAGONIA_SCIENCE', 0,      'KIND_MODIFIER', 2);
...
INSERT INTO ModifierArguments 
       (ModifierId,                                Name,        Value) 
VALUES ('MOD_NYGUITA_GIANTS_OF_PATAGONIA_SCIENCE', 'YieldType', 'YIELD_SCIENCE');

INSERT INTO ProgressionTreeNodeUnlocks 
       (ProgressionTreeNodeType,          TargetType,                                   Hidden, TargetKind,      UnlockDepth) 
VALUES ('CIVIC_NYGUITA_TANGO_AND_POETRY', 'MOD_NYGUITA_GIANTS_OF_PATAGONIA_PRODUCTION', 0,      'KIND_MODIFIER', 2);
...
INSERT INTO ModifierArguments 
       (ModifierId,                                   Name,       Value) 
VALUES ('MOD_NYGUITA_GIANTS_OF_PATAGONIA_PRODUCTION', 'UnitType', 'UNIT_EXPLORER');
...
INSERT INTO ProgressionTreePrereqs 
       (Node,                             PrereqNode) 
VALUES ('CIVIC_NYGUITA_TANGO_AND_POETRY', 'CIVIC_NYGUITA_CONGRESS_OF_TUCUMAN');
