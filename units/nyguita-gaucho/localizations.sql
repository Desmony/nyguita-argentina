...
VALUES ('en_US',  'LOC_UNIT_NYGUITA_GAUCHO_NAME', 'Gaucho'),
       ...
       ('en_US',  'LOC_UNIT_NYGUITA_GAUCHO_BASE_DESCRIPTION', 'Argentinian Unique Additional Cavalry Unit. +3 [icon:NAR_REW_COMBAT] [TIP:LOC_PEDIA_CONCEPTS_COMBAT_STRENGTH_TOOLTIP]Combat Strength[/TIP] when on [TIP:LOC_PEDIA_CONCEPTS_FLAT_TERRAIN_TOOLTIP]Flat Terrain[/TIP]. Doubled when on a farm. Weaker but less expensive to train.'),
       ('en_US',  'LOC_UNIT_NYGUITA_GAUCHO_DESCRIPTION', 'Tier 1 Argentinian Unique Additional Cavalry Unit. +3 [icon:NAR_REW_COMBAT] [TIP:LOC_PEDIA_CONCEPTS_COMBAT_STRENGTH_TOOLTIP]Combat Strength[/TIP] when on [TIP:LOC_PEDIA_CONCEPTS_FLAT_TERRAIN_TOOLTIP]Flat Terrain[/TIP]. Doubled when on a farm. Weaker but less expensive to train.'),
       ('en_US',  'LOC_UNIT_NYGUITA_GAUCHO_2_DESCRIPTION', 'Tier 2 Argentinian Unique Additional Cavalry Unit. +3 [icon:NAR_REW_COMBAT] [TIP:LOC_PEDIA_CONCEPTS_COMBAT_STRENGTH_TOOLTIP]Combat Strength[/TIP] when on [TIP:LOC_PEDIA_CONCEPTS_FLAT_TERRAIN_TOOLTIP]Flat Terrain[/TIP]. Doubled when on a farm. Weaker but less expensive to train.'),
       ('en_US',  'LOC_UNIT_NYGUITA_GAUCHO_3_DESCRIPTION', 'Tier 3 Argentinian Unique Additional Cavalry Unit. +3 [icon:NAR_REW_COMBAT] [TIP:LOC_PEDIA_CONCEPTS_COMBAT_STRENGTH_TOOLTIP]Combat Strength[/TIP] when on [TIP:LOC_PEDIA_CONCEPTS_FLAT_TERRAIN_TOOLTIP]Flat Terrain[/TIP]. Doubled when on a farm. Weaker but less expensive to train.'),
       ...
       ('en_US',  'LOC_ABILITY_NYGUITA_GAUCHO_DESCRIPTION', '+3 [icon:NAR_REW_COMBAT] [TIP:LOC_PEDIA_CONCEPTS_COMBAT_STRENGTH_TOOLTIP]Combat Strength[/TIP] when on [TIP:LOC_PEDIA_CONCEPTS_FLAT_TERRAIN_TOOLTIP]Flat Terrain[/TIP]. Doubled when on a farm.'),
