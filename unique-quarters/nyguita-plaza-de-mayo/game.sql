...
VALUES ('MOD_NYGUITA_PLAZA_DE_MAYO_HAPPINESS', 'ModifierId', 'ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_HAPPINESS');

INSERT INTO Types 
       (Type,                                                       Kind) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_HAPPINESS_TYPE', 'KIND_MODIFIER');

INSERT INTO DynamicModifiers 
       (ModifierType,                                               CollectionType,                EffectType) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_HAPPINESS_TYPE', 'COLLECTION_CITY_PLOT_YIELDS', 'EFFECT_PLOT_ADJUST_YIELD');

INSERT INTO Modifiers 
       (ModifierId,                                            ModifierType,                                               Permanent) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_HAPPINESS', 'ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_HAPPINESS_TYPE', 1);

INSERT INTO ModifierArguments 
       (ModifierId,                                            Name,     Value) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_HAPPINESS', 'Amount', '1');

INSERT INTO ModifierArguments 
       (ModifierId,                                            Name,        Value) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_HAPPINESS', 'YieldType', 'YIELD_HAPPINESS');

INSERT INTO ModifierArguments 
       (ModifierId,                                          Name,         Value) 
VALUES ('MOD_NYGUITA_PLAZA_DE_MAYO_INFLUENCE', 'ModifierId', 'ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_INFLUENCE');

INSERT INTO Types 
       (Type,                                                       Kind) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_INFLUENCE_TYPE', 'KIND_MODIFIER');

INSERT INTO DynamicModifiers 
       (ModifierType,                                               CollectionType,                EffectType) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_INFLUENCE_TYPE', 'COLLECTION_CITY_PLOT_YIELDS', 'EFFECT_PLOT_ADJUST_YIELD');

INSERT INTO Modifiers 
       (ModifierId,                                            ModifierType,                                               Permanent) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_INFLUENCE', 'ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_INFLUENCE_TYPE', 1);

INSERT INTO ModifierArguments 
       (ModifierId,                                            Name,     Value) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_INFLUENCE', 'Amount', '1');

INSERT INTO ModifierArguments 
       (ModifierId,                                            Name,        Value) 
VALUES ('ATTACH_MOD_NYGUTIA_ARGENTINA_PLAZA_DE_MAYO_URBAN_INFLUENCE', 'YieldType', 'YIELD_DIPLOMACY');
