...
VALUES ('StandardLeaders', 'LEADER_BOLIVAR', 'ModernAgeCivilizations', 'CIVILIZATION_NYGUITA_ARGENTINA', 2,    'LOC_UNLOCK_PLAY_AS_BOLIVAR_NYGUITA_ARGENTINA_TOOLTIP', 'LOC_CREATE_GAME_HISTORICAL_CHOICE'),
       ('StandardLeaders', 'LEADER_AMINA', 'ModernAgeCivilizations', 'CIVILIZATION_NYGUITA_ARGENTINA', 2,    'LOC_UNLOCK_PLAY_AS_AMINA_NYGUITA_ARGENTINA_TOOLTIP', 'LOC_CREATE_GAME_STRATEGIC_CHOICE');
